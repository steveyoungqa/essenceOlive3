...
#(reviewed 5th May)
@todo - Add to JIRA
Scenario: Olive 3 autogenerated Olive 2 entities cannot be edited via Olive 2 forms
  Given Campaign financial information for an evergreen is due to be managed thorugh Olive 3 as of new quarter
