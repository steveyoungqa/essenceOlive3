...
#   ***DELETE CAMPAIGN CLEAN UP***
  ...
  Examples:
    ...
    |guestregression|google|automation |EMEA   |q4-2015|100000|Client Liable|wildfire  |Google Ireland|2604|Shopping      |Steve Automation |Post Click Revenue|Enterprise - Apps|Begin Here|Chromecast B2C - Essence EMEA|Google Floodlights|
